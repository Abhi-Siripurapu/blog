...
1. **genetic engineering without bounds**: we’re already working on gene therapies, but what if we had AI designing entirely novel genes? if we reach the point where AI can understand genetic pathways at scale, then it could engineer organisms with capabilities we can barely imagine. think biofuels that are actually efficient. bacteria that consume plastic and pump out clean water. plants that thrive in salty soil.
